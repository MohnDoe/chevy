...
${c}`);
    ...
    var Eg = globalThis.process?.versions?.electron !== void 0;
    var bg = globalThis.navigator?.userAgent?.includes("jsdom") === true;
...
${a.backtrace}`, { clientVersion: this.config.clientVersion });
    ...
    function vo(e, r) {
      return bl({ binaryTarget: e.binaryTarget, title: r, version: e.config.clientVersion, engineVersion: e.versionInfo?.commit, database: e.config.activeProvider, query: e.lastQuery });
    }
...
// index.ts
__reExport(index_exports, __toESM(require_prisma(), 1), module.exports);
